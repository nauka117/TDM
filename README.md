...
## Pre-trained Models
The pre-trained models include TDM-dreamshaper-LoRA, TDM-SD3-LoRA, TDM-CogVideoX-1.5B-LoRA, which are released in our [huggingface repo](https://huggingface.co/Luo-Yihong/TDM). Please check it!
